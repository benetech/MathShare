...
export default class ModalContainer extends Component {
    ...
    render() {
        ...
        <PaletteChooser title={Locales.strings.choose_palettes_title} cancelCallback={() => this.props.toggleModals([PALETTE_CHOOSER])}
            nextCallback={this.props.progressToAddingProblems} deactivateModal={() => this.props.toggleModals([PALETTE_CHOOSER])}/>
        : null;
