        ...
        this.strings = new LocalizedStrings({
            en: {
                ...
                sharing_solution_sets_steps: [
                    'Links for sharing are in the upper right side of the problem set page.',
                    'Completed problem sets can be shared with a link, through Google Classroom, or through Microsoft Teams.',
                    'When someone opens the link you shared they will be able to view your steps. They will not be able to edit any of your work.',
                ],
