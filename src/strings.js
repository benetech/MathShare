    ...
    constructor() {
        this.strings = new LocalizedStrings({
            en: {
                ...
                mobile_not_supported_v2: 'Mathshare is moving to Chakshumathi Assistive technology center.  Learn more about these exciting changes.',
                mobile_view: 'Learn More',
                ...
                unable_to_switch_to_v2: 'Unable to switch, please check if your local storage access is enabled',
